...
const eventRouter = () => {
  ...
  router.get('/rooms/:roomId/events/:id', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
  ...
  router.get('/rooms/:roomId/events/date/:date', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
  ...
  router.get('/rooms/:roomId/events/month/:year/:month', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
  ...
  // POST new event
  router.post('/rooms/:roomId/events', eventValidationRules, async (req, res) => {
    try {
  ...
  router.put('/rooms/:roomId/events/:id', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
  ...
  router.post('/rooms/:roomId/events/:id/attendance', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
  ...
  // DELETE event
  router.delete('/rooms/:roomId/events/:id', async (req, res) => {
    try {
      const roomId = parseInt(req.params.roomId)
